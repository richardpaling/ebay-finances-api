...
class OrderLineItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'line_item_id' => 'string',
        'marketplace_fees' => '\OpenAPI\Client\Model\Fee[]'
    ];
     ...
     *
     * @param \OpenAPI\Client\Model\Amount|null $fee_basis_amount fee_basis_amount
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\Fee[]|null $marketplace_fees An array of all fees accrued for the order line item and deducted from a seller payout.
     *
     * @return self
     */
