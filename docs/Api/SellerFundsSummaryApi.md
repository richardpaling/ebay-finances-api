# OpenAPI\Client\SellerFundsSummaryApi
...
```php
getSellerFundsSummary(): \OpenAPI\Client\Model\SellerFundsSummaryResponse
```
...
$apiInstance = new OpenAPI\Client\Api\SellerFundsSummaryApi(
...
[**\OpenAPI\Client\Model\SellerFundsSummaryResponse**](../Model/SellerFundsSummaryResponse.md)
